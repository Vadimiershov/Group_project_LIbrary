Feature: Librarian should be able to add users with valid info
  ...
  Scenario Outline:
    ...
    Examples:
      ...
      | Beyonce B        | 123@456# | beyoncef@mail.ru        | Students   | ACTIVE   | 2021/03/01 | 2022/03/01 | San Diego, Ca   |
      | Shakira Gonzalez | 567@89&$ | shakirashakiraf@mail.ru | Librarian  | INACTIVE | 2022/02/01 | 2023/02/01 | Los Angeles, Ca |
